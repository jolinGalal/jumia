...
func New(
	...
	return &Server{
		Mounts: []*MountPoint{
			{"gen/http/openapi.json", "GET", "/customers/v1/swagger/swagger.json"},
		},
...
// "/customers/v1/swagger/swagger.json".
func MountGenHTTPOpenapiJSON(mux goahttp.Muxer, h http.Handler) {
	mux.Handle("GET", "/customers/v1/swagger/swagger.json", h.ServeHTTP)
}
