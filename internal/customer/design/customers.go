	...
	dsl.Method("list", func() {
		...
		dsl.Payload(func() {
			dsl.Field(1, "country", dsl.String, func() {
				...
				dsl.Enum(types.Country.All, types.Country.Cameroon, types.Country.Ethiopia,
					types.Country.Morocco, types.Country.Mozambique, types.Country.Uganda)
				dsl.Default(types.Country.All)
...
var ListCustomerResp = dsl.Type("ListCustomerResp", func() {
	...
	dsl.Field(2, "Name", dsl.Int, "customer name")
	dsl.Field(3, "Phone", dsl.Int, "customer phone")
	dsl.Field(4, "Country", dsl.Int, "customer country")
	dsl.Field(5, "State", dsl.Int, "phone state")
	dsl.Field(6, "CountryCode", dsl.Int, "country code")
